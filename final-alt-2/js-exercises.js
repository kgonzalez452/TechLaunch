...
var c = 10;
var x = b*c + a;
Answer: the value of x is 50thuglife
//Question 2.4
//What is the value of x?
var x = 10;
var y = 6;
...
var z = 4; 
x = x*z; 10*4
Answer: the value of x is 60,40
...
var city = "Miami"
Answer: console.log(firstName + "" + lastName + " went to " + city +" to go chill at a beach with some friends.");

//Question 3.2
//Write a sentence that uses the following variables
totalPower = 32
generator = 1
Answer: console.log("Generator " + generator + " has a total power of " + totalPower + "!");
...
var greeting = "Hi!";
var name = "Slim Shady";
Answer: console.log(greeting + "" + name);
